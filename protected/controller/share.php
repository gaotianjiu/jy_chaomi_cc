 ...
 *
 */
class share extends spController{
    ...
    function index(){
		...
		$ret = $pub_ecommend->spPager($page, pgsize)->findAll(array('ecommend_uid'=>$uid),"create_time desc");
		//分页开始
        $pager = $pub_ecommend->spPager()->getPager();
